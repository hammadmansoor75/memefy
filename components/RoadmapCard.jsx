...
const RoadmapCard = () => {
  return (
    <div className="container mx-auto w-full">
      <div
        className="w-full sm:min-h-[500px] md:h-[500px] lg:h-[550px] rounded-3xl"
        style={{
      ...
      >
        ...
        <div className="flex items-center justify-between h-full px-4 sm:px-6 md:px-8 lg:px-10">
          ...
          <div className="relative h-full w-full md:w-1/2 hidden md:flex items-center justify-center">
            <Image
            ...
            {/* Right Side (Content) */}
          <div className="w-full lg:w-1/2 h-full py-5 flex flex-col items-end justify-start" >
